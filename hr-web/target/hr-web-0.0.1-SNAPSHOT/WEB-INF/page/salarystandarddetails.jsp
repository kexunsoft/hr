...
<div class="notice_main">
			<div class="notice_check">
				...
				<div class="btn-group r_right">
					<a class="btn btn-default btn-sm" href="/hr/Salarystandarddetails/salarystandarddetailsadd"><span class="glyphicon glyphicon-plus"></span>新增</a>
				</div>
				<div class="clear"></div>
			</div>
...
function del(itemid) {
    layer.confirm('确定要删除这个机构吗?', {icon: 3, title: '提示'}, function (index) {
        ...
        var i;
        $.ajax({
            url: "/hr/Salarystandarddetails/deleteSalarystandarddetails",
            data: {"itemid": itemid},
            type: "get",
            beforeSend: function () {
                i = layer.msg('请稍后...', {
