    ...
    <div class="col-lg-8">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <input class="form-control" type="text" required="required" readonly="readonly"
                       value="${configfilesecond.firstKindName}" name="firstkindname">
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg-4 control-label">II级机构编号<span
                    style="color: red;">&nbsp;*</span></label>
            <div class="col-lg-5">
                <input class="form-control" type="text" name="secondkindid" required="required" readonly="readonly"
                       value="${configfilesecond.secondKindId}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <input class="form-control" type="text" required="required" readonly="readonly"
                       value="${configfilesecond.secondKindName}" name="secondkindname">
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-lg-4 control-label">薪酬发放责任人编号<span
                    style="color: red;">&nbsp;*</span></label>
            <div class="col-lg-5">
                <textarea placeholder="多个编号之间请用'半角逗号'加'一个空格'隔开，如', '" class="form-control"
                          name="firstKindSalaryId">${configfilesecond.secondSalaryId}</textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <textarea placeholder="多个编号之间请用'半角逗号'加'一个空格'隔开，如', '" class="form-control"
                          name="firstKindSaleId" required>${configfilesecond.secondSaleId}</textarea>
            </div>
        </div>
...
<script>
    ...
    function save() {
        ...
        var i;
        $.ajax({
            url: "${pageContext.request.contextPath}/Configfilesecondkind/configfilesecondkindmodify",
            data: formData,
            type: "post",
            beforeSend: function () {
                //						layer.load()
