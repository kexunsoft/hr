...
<div class="notice_main">
    <div class="notice_check">
        <div class="l_left">
            <form class="form-inline" action="${pageContext.request.contextPath}/engageResume/effectiveResumeList">
    ...
    <table id="table" class="table table-condensed table-bordered" style="margin: 0 auto">
        ...
        <c:forEach items="${pageInfo.list}" var="r">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/engageResume/resumeInfo?resumeId=${r.resId}">查看详情</a></td>
            </tr>
        </c:forEach>
    </table>
</div>
