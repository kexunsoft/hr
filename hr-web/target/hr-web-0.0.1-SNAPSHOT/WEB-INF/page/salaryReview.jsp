...
<form id="form1" action="javascript:save()" class="form-horizontal">
    <div class="col-lg-6">
        ...
        <div class="form-group">
            <label class="col-lg-4 control-label">复核意见<span
                    style="color: red;">&nbsp;*</span></label></label>
            <div class="col-lg-5">
                <textarea class="form-control" name="checkcomment" required></textarea>
            </div>
        </div>

        <div class="form-group">
            <label class="col-lg-4 control-label">审核状态<span
                    style="color: red;">&nbsp;*</span></label></label>
            <div class="col-lg-5">
                <label class="radio-inline">
                    <input type="radio" name="checkstatus" checked value="1"> 通过
                </label>
                <label class="radio-inline">
...
<script>
    ...
    function save() {
        ...
        var i;
        $.ajax({
            url: "${pageContext.request.contextPath}/salarystandardController/review",
            data: formData,
            type: "post",
            beforeSend: function () {
                //						layer.load()
            ...
            success: function (data) {
                ...
                if (data.code == 200) {
                    layer.msg(data.message, {
                            ...
                            window.location.href = "${pageContext.request.contextPath}/salarystandardController/compensationStandards";
                        }
                    )
                } else {
                    layer.msg(data.message, {
