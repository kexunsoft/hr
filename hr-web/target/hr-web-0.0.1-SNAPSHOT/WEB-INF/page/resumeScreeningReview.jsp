    ...
    <div class="notice_check">
        ...
        <div class="btn-group r_right">
            <a class="btn btn-sm btn-success"
               href="javascript:execute(${resume.resId})">有效简历</a>
...
<script>
    ...
    function execute(resId) {
        var i;
        $.ajax({
            url: '${pageContext.request.contextPath}/engageResume/effectiveResume',
            data: {"resid": resId},
            type: 'post',
            beforeSend: function () {
                i = layer.msg('请稍后....', {
                ...
                if (data.code == 200) {
                    layer
                        .msg(
                            ...
                            function () {
                                window.location.href = "${pageContext.request.contextPath}/engageResume/effectiveResumeList";
                            })
                } else {
