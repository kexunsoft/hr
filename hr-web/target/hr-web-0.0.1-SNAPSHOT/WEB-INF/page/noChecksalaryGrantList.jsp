    ...
    <table id="table" class="table table-condensed table-bordered" style="margin: 0 auto">
        ...
        <c:forEach items="${pageInfo.list}" var="s">
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/salaryGrant/review?salaryGrantId=${s.salaryGrantId}&humanAmount=${s.humanAmount}&salaryStandardSum=${s.salaryStandardSum}">复核</a>
                </td>
            </tr>
        </c:forEach>
    </table>
