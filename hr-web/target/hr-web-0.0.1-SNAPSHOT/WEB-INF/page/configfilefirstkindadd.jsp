...
<form id="form1" action="javascript:save()" class="form-horizontal">
    ...
    <div class="col-lg-8">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <input class="form-control" type="text" required="required" value="" name="firstkindname">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <textarea placeholder="多个编号之间请用'半角逗号'加'一个空格'隔开，如', '" class="form-control"
                          name="firstKindSalaryId"></textarea>
            </div>
        </div>
...
<script>
    ...
    function save() {
        ...
        var i;
        $.ajax({
            url: "${pageContext.request.contextPath}/Configfilefirstkind/configfilefirstkindadd",
            data: formData,
            type: "post",
            beforeSend: function () {
                //						layer.load()
