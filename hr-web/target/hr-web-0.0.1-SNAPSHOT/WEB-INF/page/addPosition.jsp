    ...
    <script>
        ...
        $(function () {
            ...
            $("#oneji").change(function () {
                ...
                var oneid = $(this).val();
                $.get('/hr/Configfilesecondkind/findByFirstKindId', {'firstKindId': oneid}, function (data) {
                    $.each(data, function (index, item) {
            ...
            $("#twoji").change(function () {
                $("#threeji option:gt(0)").remove();
                var twoid = $(this).val();
                $.get('/hr/Configfilethirdkind/findBysecondKindIdConfigfilethirdkind', {'secondkindid': twoid}, function (data) {
                    $.each(data, function (index, item) {
...
<script>
    function save() {
        ...
        var i;
        $.ajax({
            url: "/hr/engageMajorRelease/addPosition",
            data: formData,
            type: "post",
            beforeSend: function () {
                //						layer.load()
