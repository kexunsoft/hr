    ...
    <div class="notice_check">
        ...
        <div class="btn-group r_right">
            <a class="btn btn-sm btn-success"
               href="javascript:save()">申请录用 </a>
            <a class="btn btn-sm btn-danger"
               href="javascript:del()">释放简历 </a>
...
<script>
    function del() {
        ...
        layer.confirm('此操作将释放简历,确定要继续操作吗?', {icon: 3, title: '提示'}, function (index) {

            var i;
            $.ajax({
                url: "${pageContext.request.contextPath}/engageInterview/applicationResult?state=0&resumeId=${interview.resumeId}&einId=${interview.einId}",
                type: "get",
                beforeSend: function () {
                    i = layer.msg('请稍后...', {
                        icon: 16,
                ...
                success: function (data) {
                    ...
                    if (data.code == 200) {
                        layer.msg(data.message, {
                                ...
                                window.location.href = "${pageContext.request.contextPath}/engageInterview/employmentApplicationList";
                            }
                        )
                    } else {
                        layer.msg(data.message, {
    ...
    function save() {
        var i;
        $.ajax({
            url: "${pageContext.request.contextPath}/engageInterview/applicationResult?state=1&resumeId=${interview.resumeId}&einId=${interview.einId}",
            type: "get",
            beforeSend: function () {
                i = layer.msg('请稍后...', {
                    icon: 16,
