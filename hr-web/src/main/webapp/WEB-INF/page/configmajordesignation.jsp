...
<body style="background-color: #ecf0f5;font-family: 微软雅黑;color: #475059;min-width: 1000px;overflow: auto">
		<div class="notice_main">
			...
			<table id="table" class="table table-condensed" style="margin: 0 auto">
				...
				<c:forEach items="${pageInfo.list}" var="cg">
						<tr>
							<td>${cg.cmdname}</td>
							<td><a href="javascript:del(${cg.cmdid})">删除</a></td>
						</tr>
				</c:forEach>
			</table>
...
function del(cmdid) {
    layer.confirm('确定要删除这个机构吗?', {icon: 3, title: '提示'}, function (index) {
        ...
        var i;
        $.ajax({
            url: "${pageContext.request.contextPath}/Configmajordesignation/deleteconfigmajordesignation",
            data: {"cmdid": cmdid},
            type: "get",
            beforeSend: function () {
                i = layer.msg('请稍后...', {
            ...
            success: function (data) {
                ...
                if (data.code == 200) {
                    layer.msg(data.message, {
                            ...
                            window.location.href = "${pageContext.request.contextPath}/Configmajordesignation/configmajordesignationQueryAll";
                        }
                    )
                } else {
                    layer.msg(data.message, {
