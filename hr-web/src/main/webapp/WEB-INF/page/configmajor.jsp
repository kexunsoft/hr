...
<div class="notice_main">
			<div class="notice_check">
				...
				<div class="btn-group r_right">
					<a class="btn btn-default btn-sm" href="/hr/Configmajor/configmajorAdd"><span class="glyphicon glyphicon-plus"></span>新增</a>
				</div>
				<div class="clear"></div>
			</div>
...
function del(majorid) {
    layer.confirm('确定要删除这个机构吗?', {icon: 3, title: '提示'}, function (index) {
        ...
        var i;
        $.ajax({
            url: "/hr/Configmajor/deleteconMajorid",
            ...
            success: function (data) {
                ...
                if (data.code == 200) {
                    layer.msg(data.message, {
                            ...
                            window.location.href = "/hr/Configmajor/configmajorQueryAll";
                        }
                    )
                } else {
                    layer.msg(data.message, {
