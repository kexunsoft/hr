...
<div class="notice_main">
			<div class="notice_check">
				...
				<div class="btn-group r_right">
					<a class="btn btn-default btn-sm" href="/hr/Configfilethirdkind/configfilethirdkindadd"><span class="glyphicon glyphicon-plus"></span>新增</a>
				</div>
				<div class="clear"></div>
			</div>
			<table id="table" class="table table-condensed" style="margin: 0 auto">
				...
				<c:forEach items="${pageInfo.list}" var="ct">
						<tr>
							...
							<td><a href="/hr/Configfilethirdkind/configfilethirdkindmodify?thirdkindid=${ct.thirdKindId}">变更</a></th>
							</th>
...
function del(thirdkindid) {
    layer.confirm('确定要删除这个机构吗?', {icon: 3, title: '提示'}, function (index) {
        ...
        var i;
        $.ajax({
            url: "/hr/Configfilethirdkind/deleteconfigfilethirdkind",
