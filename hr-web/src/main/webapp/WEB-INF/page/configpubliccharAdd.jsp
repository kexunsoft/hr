...
<form id="form1" action="javascript:save()" class="form-horizontal">
    ...
    <div class="col-lg-8">
        ...
        <div class="form-group">
            <label class="col-lg-4 control-label">属性种类<span
                    style="color: red;">&nbsp;*</span></label>
            <div class="col-lg-5">
                <input class="form-control" type="text" required="required"
                       value="" name="attributekind">
            </div>
        </div>

        <div class="form-group">
            <label class="col-lg-4 control-label">属性名称<span
                    style="color: red;">&nbsp;*</span></label>
            <div class="col-lg-5">
                <input class="form-control" type="text" required="required"
...
<script>
    function save() {
        ...
        $
            .ajax({
                url: "${pageContext.request.contextPath}/Configpublicchar/configpubliccharadd",
                data: formData,
                type: "post",
                beforeSend: function () {
                    //						layer.load()
